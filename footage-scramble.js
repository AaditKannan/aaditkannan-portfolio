/**
 * Footage page scramble animations
 */

document.addEventListener('DOMContentLoaded', () => {
  const heading = document.getElementById('footageHeading');
  const subheading = document.getElementById('footageSubheading');
  const description = document.getElementById('footageDescription');
  ...
  // Fade in description after subheading
  if (description) {
    setTimeout(() => {
